...
const ICONS: Record<CardCategory, string> = {
  [CardCategory.DESIGN]: `<svg width="24" height="24" viewBox="0 0 24 24">${
    demoCategoryIcons[CardCategory.DESIGN]
  }</svg>`,
  [CardCategory.DEVELOPMENT]: `<svg width="24" height="24" viewBox="0 0 24 24">${
    demoCategoryIcons[CardCategory.DEVELOPMENT]
  }</svg>`,
  [CardCategory.HARLEY]: `<svg width="24" height="24" viewBox="0 0 24 24">${
    demoCategoryIcons[CardCategory.HARLEY]
  }</svg>`,
  [CardCategory.LORE]: `<svg width="24" height="24" viewBox="0 0 24 24">${
    demoCategoryIcons[CardCategory.LORE]
  }</svg>`,
  [CardCategory.SPECIAL]: `<svg width="24" height="24" viewBox="0 0 58 38">${
    demoCategoryIcons[CardCategory.SPECIAL]
  }</svg>`,
  [CardCategory.TOOLS]: `<svg width="24" height="24" viewBox="0 0 24 24">${
    demoCategoryIcons[CardCategory.TOOLS]
  }</svg>`,
  [CardCategory.TROLL]: `<svg width="24" height="24" viewBox="0 0 24 24">${
    demoCategoryIcons[CardCategory.TROLL]
  }</svg>`,
};
    ...
    this.shadowRoot!.innerHTML = /* html */ `
      ...
      this.cardLevel
        ...
        <div class="card-level-dots">
          ${Array.from(
            { length: this.cardLevel },
            () => '<span class="card-level-dot"></span>'
          )
            .slice(0, 50)
            .join("")}
        </div>
